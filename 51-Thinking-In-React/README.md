...
Step 5: Add Inverse Data Flow (Build each feature)

### Let's make an app from scratch
X I can see 150 pokemon on load of the page
X As a user, I can double click to add pokemon to my team
X As a user, I can double click an added pokemon to remove from my team
- As a user, I can single click any pokemon to see their details

- When single click of a pokemon, make a GET fetch, update my DOM(state)
