...
class PaintingForm extends React.Component {
  ...
  render() {
    console.log("PaintingForms:", this.props)
    return (
...
//on click of save => dispatch action => reducer
...
export default withRouter(connect(mapStateToProps, {updatePaintingInfo: updatePainting} )(PaintingForm));
